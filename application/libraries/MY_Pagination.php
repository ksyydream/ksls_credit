...
class MY_Pagination extends CI_Pagination {
	...
	function getPageLink4manager($base_url, $total_rows, $per_page) {
		...
		return '共 ' . $total_rows . ' 条记录<div><ul class="pagination">' . $this->create_links() . '</ul></div>';
	}

	function getPageLink4manager_by4($base_url, $total_rows, $per_page) {
	...
	function getPageLink4home($base_url, $total_rows, $per_page) {
